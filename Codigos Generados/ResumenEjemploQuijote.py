# -*- coding: utf-8 -*-
"""
Created on Tue Jun  9 17:55:10 2015
...
texto = """
La novela consta de dos partes: El ingenioso hidalgo don Quijote de la Mancha, publicada con fecha de 1605, aunque impresa en diciembre de 1604, momento en que ya debió poder leerse en Valladolid,4 y la Segunda parte del ingenioso caballero don Quijote de la Mancha, publicada en 1615.5
...
print resumir(texto,ratio = 0.2)
print "*"*45
print resumir(texto,ratio = 0.5)