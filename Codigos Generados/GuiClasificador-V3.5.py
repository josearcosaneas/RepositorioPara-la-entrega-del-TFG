    ...
    def ClickBotonClasificar(self, evt):
        ...
        for i in range(0,len(contenido.etiquetas)):
             ...
             def Guardar(): 
                  ...
                  newElements = xmlFile.createElement("materias")
                  xmlFile.appendChild(newElements)
                  newElements.writexml(etiquetasElegidas)
             ...
             text2 = Text(ventana, height=20, width=200)
             text2.tag_configure('bold_italics', font=('Arial', 12, 'bold', 'italic'))
             text2.tag_configure('big',foreground='#A69562', font=('Verdana', 20, 'bold'),background="#F8F3E4")
             text2.tag_configure('color', foreground='black', background="#F8F3E4",font=('Tempus Sans ITC', 12, 'bold'))
             text2.insert(END,extractoTs[i][0], 'big')
